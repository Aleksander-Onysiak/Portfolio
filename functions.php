...
if (file_exists($manifestPath)) {
    ...
    if (isset($manifest['wp-content/theme/portfolio/src/js/main.js'])) {
        wp_enqueue_script('portfolio', get_theme_file_uri('dist/' . $manifest['wp-content/themes/portfolio/src/js/main.js']['file']), [], null, true);
    }

    if (isset($manifest['wp-content/theme/portfolio/src/css/style.scss'])) {
        wp_enqueue_style('portfolio', get_theme_file_uri('dist/' . $manifest['wp-content/themes/portfolio/src/css/style.scss']['file']));
    }
}
...
if (file_exists($manifestPath)) {
    ...
    if (isset($manifest['wp-content/themes/portfolio/src/js/main.js'])) {
        wp_enqueue_script('portfolio', get_theme_file_uri('dist/' . $manifest['wp-content/themes/portfolio/src/js/main.js']['file']), [], null, true);
    }

    if (isset($manifest['wp-content/themes/portfolio/src/css/style.scss'])) {
        wp_enqueue_style('portfolio', get_theme_file_uri('dist/' . $manifest['wp-content/themes/portfolio/src/css/style.scss']['file']));
    }
}
